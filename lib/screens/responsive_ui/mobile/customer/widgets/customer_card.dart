              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    CustomCheckbox(
                      value: heart!,
                      onChanged: (newValue) => setState(() => heart = newValue),
                      label: "Καρδιολογικά ",
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomCheckbox(
                      value: neuro!,
                      onChanged: (newValue) => setState(() => neuro = newValue),
                      label: "Νευρολογικά",
                      activeColor: Colors.green,
                      checkColor: Colors.white,
                      size: 22,
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomCheckbox(
                      value: good!,
                      onChanged: (newValue) => setState(() => good = newValue),
                      label: "Καλή",
                      activeColor: Colors.green,
                      checkColor: Colors.white,
                      size: 28,
                    ...
                    CustomCheckbox(
                      value: bad!,
                      onChanged: (newValue) => setState(() => bad = newValue),
                      label: "Κακή",
                      activeColor: Colors.green,
                      checkColor: Colors.white,
                      size: 28,
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomCheckbox(
                      value: yes!,
                      onChanged: (newValue) => setState(() => yes = newValue),
                      label: "Ναι",
                      activeColor: Colors.green,
                      checkColor: Colors.white,
                      size: 22,
                    ...
                    CustomCheckbox(
                      value: no!,
                      onChanged: (newValue) => setState(() => no = newValue),
                      label: "Όχι",
                      activeColor: Colors.green,
                      checkColor: Colors.white,
                      size: 22,
